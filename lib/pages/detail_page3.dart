...
class DetailPageThree extends StatefulWidget {
  ...
  @override
  State<DetailPageThree> createState() => _DetailPageThreeState();
}
              ...
              child: Container(
                ...
                decoration: const BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage("img/mountain-three.png"),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        AppLargeText(text: "Darjeeling", color: Colors.black.withOpacity(0.8)),
                        AppLargeText(text: "18000", color: AppColors.mainColor),
                      ],
                    ),
                    ...
                    Row(
                      children: [
                        ...
                        AppText(text: "West Bengal, India", color: AppColors.textColor1),
                      ],
                    ),
                    ...
                    const SizedBox(height: 5),
                    AppText(
                      text: "Darjeeling is a town in India's West Bengal state, in the Himalayan foothills. Once a summer resort for the British Raj elite, it remains the terminus of the narrow-gauge Darjeeling Himalayan Railway, or “Toy Train,” completed in 1881.",
